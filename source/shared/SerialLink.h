...
/*******************************************************************************************
 * 
 * Design challenge: Linux serial read fctns and Pico serial (UART) read functions are radically
 ...
 * there is a problem with the serial link.  However, Pico offers a function to check if there is 
 ...
 * 
 * 1.   Check the serial link for messag#include <SerialMessage.h>    // for MsgIdes by calling getMsgType() which either returns the message type
 *      or std::nullopt.
