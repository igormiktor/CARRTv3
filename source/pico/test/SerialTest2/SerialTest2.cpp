            ...
            switch ( eventCode )
            {
                case EvtId::kNavUpdateEvent:
                    ...
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART,
                                   static_cast<char>( MsgId::kTimerNavUpdate ) );
                ...
                case EvtId::kQuarterSecondTimerEvent:
                    ...
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART,
                                   static_cast<char>( MsgId::kTimerEventMsg ) );
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART,
                                   static_cast<char>( TimerEventMsg::k1QuarterSecondEvent ) );
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART, static_cast<char>( eventParam ) );
                    break;
                ...
                case EvtId::kOneSecondTimerEvent:
                    ...
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART,
                                   static_cast<char>( MsgId::kTimerEventMsg ) );
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART,
                                   static_cast<char>( TimerEventMsg::k1SecondEvent ) );
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART, static_cast<char>( eventParam ) );
                ...
                case EvtId::kEightSecondTimerEvent:
                    ...
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART,
                                   static_cast<char>( MsgId::kTimerEventMsg ) );
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART,
                                   static_cast<char>( TimerEventMsg::k8SecondEvent ) );
                    uart_putc_raw( CARRTPICO_SERIAL_LINK_UART, static_cast<char>( eventParam ) );
                    break;
