/*
    BuildInfo.cpp - Contains implementation of build information related
    functions for CARRTv3
...
std::uint8_t CarrtPicoVersion::minor() noexcept { return kCarrtPicoVersionMinor; }

std::uint8_t CarrtPicoVersion::revision() noexcept { return kCarrtPicoVersionRevision; }

const char* CarrtPicoVersion::versionStr() noexcept { return kCarrtPicoVersion; }

const char* CarrtPicoVersion::buildDate() noexcept { return kCarrtPicoBuildDate; }

const char* CarrtPicoVersion::buildTime() noexcept { return kCarrtPicoBuildTime; }

std::uint32_t CarrtPicoVersion::buildDateVal() noexcept { return kCarrtPicoBuildDateVal; }

const char* CarrtPicoVersion::features() noexcept { return kCarrtPicoFeatures; }

const char* CarrtPicoVersion::hashFull() noexcept { return kCarrtPicoBuildHashFull; }
