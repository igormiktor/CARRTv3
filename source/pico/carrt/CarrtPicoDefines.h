...
// Default to use if unless explictly turned off
#ifndef USE_CARRTPICO_STDIO
    #define USE_CARRTPICO_STDIO 1
#endif    // USE_CARRTPICO_STDIO

// Force on if compiling DEBUG version
#if DEBUGCARRTPICO
...
// Uses I2C0 on GPIO8 (SDA) and GPIO9 (SCL) running at 400KHz.
    ...
    #define CARRTPICO_I2C_SPEED ( 400 * 1'000 )
...
// UART defines for the serial-link between RPi0 and Pico
    ...
    #define CARRTPICO_SERIAL_LINK_UART_BAUD_RATE 115'200
#endif    // CARRTPICO_SERIAL_LINK_UART_BAUD_RATE

#ifndef CARRTPICO_SERIAL_LINK_UART_TX_GPIO
    #define CARRTPICO_SERIAL_LINK_UART_TX_GPIO 4
#endif    // CARRTPICO_SERIAL_LINK_UART_TX_GPIO

#ifndef CARRTPICO_SERIAL_LINK_UART_RX_GPIO
    #define CARRTPICO_SERIAL_LINK_UART_RX_GPIO 5
#endif    // CARRTPICO_SERIAL_LINK_UART_RX_GPIO

// **************************************************************

// Flag value to confirm successful launch of core1

#define CORE1_SUCCESS 1'234
...
// In milliseconds (value 10 seems to work well)
#ifndef PICO_GPIO_DEBOUNCE_TIME
    #define PICO_GPIO_DEBOUNCE_TIME 10
