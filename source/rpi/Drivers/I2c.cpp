...
void I2c::write( uint8_t address, uint8_t registerAddress )
{
    ...
    if ( ret < 0 )
    {
        throw I2cError( makeErrorId( kI2cError, 2, fd ), "Error writing to i2c bus" );
    }
}
...
void I2c::write( uint8_t address, uint8_t registerAddress, uint8_t data )
{
    ...
    if ( ret < 0 )
    {
        throw I2cError( makeErrorId( kI2cError, 3, fd ), "Error writing to i2c bus" );
    }
}
...
void I2c::write( uint8_t address, uint8_t registerAddress, uint16_t data )
{
    ...
    if ( ret < 0 )
    {
        throw I2cError( makeErrorId( kI2cError, 4, fd ), "Error writing to i2c bus" );
    }
}
...
void I2c::write( uint8_t address, uint8_t registerAddress, const char* data )
{
    ...
    if ( ret < 0 )
    {
        throw I2cError( makeErrorId( kI2cError, 5, fd ), "Error writing to i2c bus" );
    }
}
...
void I2c::write( uint8_t address, uint8_t registerAddress, uint8_t* data, uint8_t numberBytes )
{
    ...
    if ( ret < 0 )
    {
        throw I2cError( makeErrorId( kI2cError, 6, fd ), "Error writing to i2c bus" );
    }
}
...
void I2c::read( uint8_t address, uint8_t registerAddress, uint8_t* value )
{
    ...
    if ( ret < 0 )
    {
        throw I2cError( makeErrorId( kI2cError, 7, fd ), "Error reading from i2c bus" );
    }
...
void I2c::read( uint8_t address, uint8_t registerAddress, uint16_t* value )
{
    ...
    if ( ret < 0 )
    {
        throw I2cError( makeErrorId( kI2cError, 8, fd ), "Error reading from i2c bus" );
    }
...
int I2c::read( uint8_t address, uint8_t registerAddress, uint8_t numberBytes, uint8_t* destination )
{
    ...
    {
        throw I2cError( makeErrorId( kI2cError, 9, fd ), "Error reading from i2c bus" );
    }
