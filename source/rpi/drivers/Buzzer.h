...
namespace Buzzer
{
    ...
    // Decide what to do
    void alert(
        const std::chrono::milliseconds& duration = kBeepDefaultBeepDuration,
        unsigned int tone = kBeepDefaultBeepTone );
    ...
    inline void readyChime()
    {
        triTone( kBeepReadyTriTone1, kBeepReadyTriTone2, kBeepReadyTriTone3 );
    }

    inline void collisionChime()
    {
        triTone( kBeepCollisionTriTone1, kBeepCollisionTriTone2,
                 kBeepCollisionTriTone3 );
    }
